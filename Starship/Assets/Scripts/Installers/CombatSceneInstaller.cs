...
namespace Installers
{
    public class CombatSceneInstaller : MonoInstaller<CombatSceneInstaller>
    {
        ...
        [SerializeField] private ExitConfirmationDialog _exitConfirmationDialog;
        ...
        public override void InstallBindings()
        {
            ...
            Container.Bind<MapPanel>().FromInstance(_mapPanel);
            ...
            Container.Bind<ExitConfirmationDialog>().FromInstance(_exitConfirmationDialog);
